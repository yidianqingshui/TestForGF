...
<html>
  <head>
    ...
    <title>My JSP 'navtest.jsp' starting page</title>
...
<link rel="stylesheet" href="${pageContext.request.contextPath}/test/css/zTreeStyle.css" type="text/css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/test/css/nav.css" />
...
<script type="text/javascript" src="${pageContext.request.contextPath}/test/js/nav.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/test/js/Menu.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/test/js/jquery.ztree.core-3.5.js"></script>
<script type="text/javascript">
	...
	var setting = {};
		...
		var zNodes =[
			{ name:"新闻管理",
			   children: [
				 { name:"新闻视频管理",icon:'${pageContext.request.contextPath}/test/img/skin_/leftlist.png'},
				 { name:"新闻频道管理",icon:'${pageContext.request.contextPath}/test/img/skin_/leftlist.png'},
				 { name:"地方新闻管理",icon:'${pageContext.request.contextPath}/test/img/skin_/leftlist.png'}
			]},
			{ name:"用户信息设置", open:true,
			   children: [
				 { name:"首页", checked:true,icon:'${pageContext.request.contextPath}/test/img/skin_/leftlist.png'},
				 { name:"表单",icon:'${pageContext.request.contextPath}/test/img/skin_/leftlist.png'},
				 { name:"表格",icon:'${pageContext.request.contextPath}/test/img/skin_/leftlist.png'},
				 { name:"自定义设置",icon:'${pageContext.request.contextPath}/test/img/skin_/leftlist.png'}
			]},
			{ name:"工作安排",
			   children: [
				 { name:"工作安排",icon:'${pageContext.request.contextPath}/test/img/skin_/leftlist.png'},
				 { name:"安排管理",icon:'${pageContext.request.contextPath}/test/img/skin_/leftlist.png'},
				 { name:"类型选择",icon:'${pageContext.request.contextPath}/test/img/skin_/leftlist.png'},
				 { name:"自定义设置",icon:'${pageContext.request.contextPath}/test/img/skin_/leftlist.png'}
			]},
			{ name:"数据管理",
			   children: [
