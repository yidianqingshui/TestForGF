...
<body>
<html:form action="/instorage" styleId="instorage">
  <div class="command">
  ...
  <td>
  入库单号：</td>
  <td><html:text property="warehouse_warrant" styleId="warehouse_warrant"/></td>
  </tr>
    <tr>
      <td width="13%">&nbsp;物料ID:</td>
      <td width="20%">&nbsp;
